...
A lo largo del proyecto nos pusimos a discutir bastante sobre si convenía utilizar un ORM o ir por SQL directo o en su defecto SQLC que ya te ahorra chequeo en temas de seguridad sin perder control . Nos dimos cuenta de que, si bien las herramientas de abstracción te permiten un desarrollo mas rapido, con el costo de tener menos control. Llegamos a la conclusión de que lo ideal es un equilibrio: usar abstracciones en lo básico, pero apoyarse en SQL puro —con herramientas como sqlc— cuando necesitás control total y claridad. Teniendo en cuenta que hoy en día con la asistencia de IA es mucho más rápido escribir y revisar consultas nativas, por lo que creemos que pierde un poco de sentido el rapido desarrollo que otorgan los ORM, consideramos que es conveniente entender a bajo nivel las consultas generadas por la IA en lugar de utilizar herramientas mas abstractas.
&nbsp;
